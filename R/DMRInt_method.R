...
library(dplyr)
#Sort DMRs in chromosome order (not necessary, just for check)
...
interval$DMR<-""
#For each interval, find all DMRs that overlap with it
...
#Remove redundant characters that caused by paste
...
#Calculate the counts of methods in each interval to
#prepare for the subsequent calculation of weight
